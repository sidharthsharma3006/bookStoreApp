...
<div >
  <div className="modal-box">
    ...
    <div className='mt-4'>
        ...
        <p className='mt-3'>Have Account?<button className='underline text-blue-500 cursor-pointer' onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</button>
        <Login/>
        </p>
